...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleGlobalException(Exception ex, HttpServletRequest request) {
        ApiResponse response = ApiResponse.builder()
                ...
                .message("Đây là một lỗi không mong muốn nè: " +ex.getMessage())
                .data(null)
                .build();
    ...
    public ResponseEntity<ApiResponse> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        ApiResponse response = ApiResponse.builder()
                ...
                .message("Validation hỏng: " +ex.getMessage().toString())
                .data(null)
                .build();
    ...
    public ResponseEntity<ApiResponse> handleResourceNotFoundException(ResourceNotFoundException ex) {
        ApiResponse response = ApiResponse.builder()
                ...
                .message("Resource not found: " + ex.getMessage().toString())
                .data(null)
                .build();
